    ...
    <div className="relative min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <video
          ...
          poster="/placeholder.svg" // Would be replaced with actual poster image
        >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6 text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Internet 5G para Eventos, Instalada em até 60 min
            </h1>
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-white/20 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                ...
                className="w-full bg-legal-cyan hover:bg-legal-cyan/90 text-legal-blue font-bold text-lg py-6"
              >
