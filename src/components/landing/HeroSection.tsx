        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6 text-white">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 text-lg mt-8">
              ...
              <div className="hidden sm:block w-px h-6 bg-white/30"></div>
              <Button variant="outline" onClick={handleWhatsAppClick} className="bg-transparent w-[12.5rem] h-[3rem] hover:bg-white/10 border-legal-cyan text-legal-cyan hover:text-white">
