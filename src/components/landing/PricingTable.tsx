  ...
  const plans = [
    {
      ...
      price: "R$ 1.499",
      features: [
        "Até 200 conexões simultâneas",
        "Instalação em 60 minutos",
        "1 Access Point profissional",
    ...
    },
    {
      ...
      features: [
        ...
        "Instalação em 60 minutos",
        "2 Access Points profissionais",
        "Redundância 4G automática",
        "Suporte técnico 24/7",
    ...
    },
    {
      ...
      features: [
        ...
        "Instalação em 60 minutos",
        "4 Access Points profissionais",
        "Redundância 4G automática",
        "Suporte técnico 24/7",
        "Dashboard de monitoramento",
        "Técnico exclusivo no local"
      ],
      isPopular: false
    }
  ];
      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {plans.map((plan) => (
            <div 
              key={plan.id}
              className={`rounded-lg overflow-hidden border ${plan.isPopular ? 'border-legal-purple shadow-lg shadow-legal-purple/20 relative' : 'border-gray-200'}`}
            >
              {plan.isPopular && (
                ...
                <ul className="space-y-4 mb-8">
                  {plan.features.map((feature, index) => (
                    <li key={index} className="flex items-start">
                      <svg 
                        className="h-6 w-6 text-legal-purple mr-2 flex-shrink-0" 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor"
                      >
        ...
        <div className="text-center bg-amber-50 p-4 rounded-lg border border-amber-200 mt-8">
          <p className="text-amber-800 font-bold">
            Agenda de junho 70% preenchida — garanta sua data antes que acabe!
          </p>
        </div>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              <Button 
                ...
                className="w-full bg-legal-purple hover:bg-legal-purple/90 text-white py-6"
              >
