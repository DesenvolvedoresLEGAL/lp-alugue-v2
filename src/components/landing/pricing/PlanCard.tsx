...
const PlanCard = ({ plan, onSelectPlan }: PlanCardProps) => {
  ...
  return (
    <div className="relative h-full">
      {plan.isPopular && (
        <div className="h-[22px] w-full absolute left-1/2 -top-4 -translate-x-1/2 z-10">
      ...
      <div
        className={`h-full rounded-lg overflow-hidden border flex flex-col transition-all duration-200 hover:border-[#040dbe] bg-white ${
          plan.isPopular
      ...
      >
        <div
          className={`bg-[#040dbe] text-white p-4 text-center h-[70px] flex items-center justify-center ${
