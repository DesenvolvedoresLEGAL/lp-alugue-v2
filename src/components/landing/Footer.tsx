          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="grid grid-cols-5 gap-3 w-max items-center">
                <a className="hover:text-legal-cyan mb-3" href="https://facebook.com/operadoralegal">
                ...
                <a className="hover:text-legal-cyan mb-3" href="https://instagram.com/universodalegal">
                ...
                <a className="hover:text-legal-cyan mb-3" href="https://www.youtube.com/@universolegal">
                ...
                <a className="hover:text-legal-cyan mb-3" href="https://www.linkedin.com/company/operadoralegal">
                ...
                <a className="hover:text-legal-cyan mb-3" href="https://www.tiktok.com/@universolegal">
