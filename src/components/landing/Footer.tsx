          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="grid grid-cols-5 gap-3 w-max items-center">
                <a className="hover:text-legal-cyan mb-3" target="_blank" href="https://facebook.com/operadoralegal" aria-label="Visite nossa página no Facebook">
                ...
                <a className="hover:text-legal-cyan mb-3" target="_blank" href="https://instagram.com/universodalegal" aria-label="Siga-nos no Instagram">
                ...
                <a className="hover:text-legal-cyan mb-3" target="_blank" href="https://www.youtube.com/@universolegal" aria-label="Assista nossos vídeos no YouTube">
                ...
                <a className="hover:text-legal-cyan mb-3" target="_blank" href="https://www.linkedin.com/company/operadoralegal" aria-label="Conecte-se conosco no LinkedIn">
                ...
                <a className="hover:text-legal-cyan mb-3" target="_blank" href="https://www.tiktok.com/@universolegal" aria-label="Veja nosso conteúdo no TikTok">
